...
import com.onion.constant.OnionConstant;
...
public class AddressUtil {
    public static String getCityInfo(String ip) {
        ...
        try {
            ...
            if (!file.exists()) {
                String tmpDir = System.getProperties().getProperty(OnionConstant.JAVA_TEMP_DIR);
                dbPath = tmpDir + "ip.db";
    ...
    public static void main(String[] args) {
        String cityInfo = getCityInfo("183.17.228.36");
